...
Target by name, pane id (`w8:p2`), or directory basename. Reach for it when the
user asks to send work to, message or get an answer from another space, pane or
worktree, or when the work belongs in a checkout other than this one.
